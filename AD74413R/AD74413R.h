	...
	/* ==================== || =================================== || ==================== */
	/* ==================== || DEFINITION OF REGS ADDRS AND VALUES || ==================== */
	/* ==================== \/ =================================== \/ ==================== */


	#define AD74413_REG_NOP_RESET							0x00000000            /*  Reset Value for NOP  */
	#define AD74413_REG_NOP										0x00000000            /*  ad74413_mmr0 No Operation Register */
	#define AD74413_REG_CH_FUNC_SETUPn_RESET	0x00000000            /*  Reset Value for CH_FUNC_SETUP[n]  */
	#define AD74413_REG_CH_FUNC_SETUP0_RESET	0x00000000            /*  Reset Value for AD74413_REG_CH_FUNC_SETUP0  */
	#define AD74413_REG_CH_FUNC_SETUP1_RESET	0x00000000            /*  Reset Value for AD74413_REG_CH_FUNC_SETUP1  */
	#define AD74413_REG_CH_FUNC_SETUP2_RESET	0x00000000            /*  Reset Value for AD74413_REG_CH_FUNC_SETUP2  */
	#define AD74413_REG_CH_FUNC_SETUP3_RESET	0x00000000            /*  Reset Value for AD74413_REG_CH_FUNC_SETUP3  */
	#define AD74413_REG_CH_FUNC_SETUP0				0x00000001            /*  ad74413_mmr0 Function Setup Register per Channel */
	#define AD74413_REG_CH_FUNC_SETUP1				0x00000002            /*  ad74413_mmr0 Function Setup Register per Channel */
	#define AD74413_REG_CH_FUNC_SETUP2				0x00000003            /*  ad74413_mmr0 Function Setup Register per Channel */
	#define AD74413_REG_CH_FUNC_SETUP3				0x00000004            /*  ad74413_mmr0 Function Setup Register per Channel */
	#define AD74413_REG_CH_FUNC_SETUPn(i)   	(AD74413_REG_CH_FUNC_SETUP0 + ((i) * 1))
	#define AD74413_REG_CH_FUNC_SETUPn_COUNT 4
	#define AD74413_REG_ADC_CONFIGn_RESET   0x00000000            /*      Reset Value for ADC_CONFIG[n]  */
	#define AD74413_REG_ADC_CONFIG0_RESET   0x00000000            /*      Reset Value for AD74413_REG_ADC_CONFIG0  */
	#define AD74413_REG_ADC_CONFIG1_RESET   0x00000000            /*      Reset Value for AD74413_REG_ADC_CONFIG1  */
	#define AD74413_REG_ADC_CONFIG2_RESET   0x00000000            /*      Reset Value for AD74413_REG_ADC_CONFIG2  */
	#define AD74413_REG_ADC_CONFIG3_RESET   0x00000000            /*      Reset Value for AD74413_REG_ADC_CONFIG3  */
	#define AD74413_REG_ADC_CONFIG0         0x00000005            /*  ad74413_mmr0 ADC Configuration Register per Channel */
	#define AD74413_REG_ADC_CONFIG1         0x00000006            /*  ad74413_mmr0 ADC Configuration Register per Channel */
	#define AD74413_REG_ADC_CONFIG2         0x00000007            /*  ad74413_mmr0 ADC Configuration Register per Channel */
	#define AD74413_REG_ADC_CONFIG3         0x00000008            /*  ad74413_mmr0 ADC Configuration Register per Channel */
	#define AD74413_REG_ADC_CONFIGn(i)      (AD74413_REG_ADC_CONFIG0 + ((i) * 1))
	#define AD74413_REG_ADC_CONFIGn_COUNT   4
	#define AD74413_REG_DIN_CONFIGn_RESET   0x0000000B            /*      Reset Value for DIN_CONFIG[n]  */
	#define AD74413_REG_DIN_CONFIG0_RESET   0x0000000B            /*      Reset Value for AD74413_REG_DIN_CONFIG0  */
	#define AD74413_REG_DIN_CONFIG1_RESET   0x0000000B            /*      Reset Value for AD74413_REG_DIN_CONFIG1  */
	#define AD74413_REG_DIN_CONFIG2_RESET   0x0000000B            /*      Reset Value for AD74413_REG_DIN_CONFIG2  */
	#define AD74413_REG_DIN_CONFIG3_RESET   0x0000000B            /*      Reset Value for AD74413_REG_DIN_CONFIG3  */
	#define AD74413_REG_DIN_CONFIG0         0x00000009            /*  ad74413_mmr0 Digital Input Configuration Register per Channel */
	#define AD74413_REG_DIN_CONFIG1         0x0000000A            /*  ad74413_mmr0 Digital Input Configuration Register per Channel */
	#define AD74413_REG_DIN_CONFIG2         0x0000000B            /*  ad74413_mmr0 Digital Input Configuration Register per Channel */
	#define AD74413_REG_DIN_CONFIG3         0x0000000C            /*  ad74413_mmr0 Digital Input Configuration Register per Channel */
	#define AD74413_REG_DIN_CONFIGn(i)      (AD74413_REG_DIN_CONFIG0 + ((i) * 1))
	#define AD74413_REG_DIN_CONFIGn_COUNT   4
	#define AD74413_REG_GPO_PARALLEL_RESET  0x00000000            /*      Reset Value for GPO_PARALLEL  */
	#define AD74413_REG_GPO_PARALLEL        0x0000000D            /*  ad74413_mmr0 GPO Parallel Data Register */
	#define AD74413_REG_GPO_CONFIGn_RESET   0x00000000            /*      Reset Value for GPO_CONFIG[n]  */
	#define AD74413_REG_GPO_CONFIG0_RESET   0x00000000            /*      Reset Value for AD74413_REG_GPO_CONFIG0  */
	#define AD74413_REG_GPO_CONFIG1_RESET   0x00000000            /*      Reset Value for AD74413_REG_GPO_CONFIG1  */
	#define AD74413_REG_GPO_CONFIG2_RESET   0x00000000            /*      Reset Value for AD74413_REG_GPO_CONFIG2  */
	#define AD74413_REG_GPO_CONFIG3_RESET   0x00000000            /*      Reset Value for AD74413_REG_GPO_CONFIG3  */
	#define AD74413_REG_GPO_CONFIG0         0x0000000E            /*  ad74413_mmr0 General Purpose Output Configuration Register per Channel */
	#define AD74413_REG_GPO_CONFIG1         0x0000000F            /*  ad74413_mmr0 General Purpose Output Configuration Register per Channel */
	#define AD74413_REG_GPO_CONFIG2         0x00000010            /*  ad74413_mmr0 General Purpose Output Configuration Register per Channel */
	#define AD74413_REG_GPO_CONFIG3         0x00000011            /*  ad74413_mmr0 General Purpose Output Configuration Register per Channel */
	#define AD74413_REG_GPO_CONFIGn(i)      (AD74413_REG_GPO_CONFIG0 + ((i) * 1))
	#define AD74413_REG_GPO_CONFIGn_COUNT   4
	#define AD74413_REG_OUTPUT_CONFIGn_RESET 0x00000000            /*      Reset Value for OUTPUT_CONFIG[n]  */
	#define AD74413_REG_OUTPUT_CONFIG0_RESET 0x00000000            /*      Reset Value for AD74413_REG_OUTPUT_CONFIG0  */
	#define AD74413_REG_OUTPUT_CONFIG1_RESET 0x00000000            /*      Reset Value for AD74413_REG_OUTPUT_CONFIG1  */
	#define AD74413_REG_OUTPUT_CONFIG2_RESET 0x00000000            /*      Reset Value for AD74413_REG_OUTPUT_CONFIG2  */
	#define AD74413_REG_OUTPUT_CONFIG3_RESET 0x00000000            /*      Reset Value for AD74413_REG_OUTPUT_CONFIG3  */
	#define AD74413_REG_OUTPUT_CONFIG0      0x00000012            /*  ad74413_mmr0 Output Configuration Register per Channel */
	#define AD74413_REG_OUTPUT_CONFIG1      0x00000013            /*  ad74413_mmr0 Output Configuration Register per Channel */
	#define AD74413_REG_OUTPUT_CONFIG2      0x00000014            /*  ad74413_mmr0 Output Configuration Register per Channel */
	#define AD74413_REG_OUTPUT_CONFIG3      0x00000015            /*  ad74413_mmr0 Output Configuration Register per Channel */
	#define AD74413_REG_OUTPUT_CONFIGn(i)   (AD74413_REG_OUTPUT_CONFIG0 + ((i) * 1))
	#define AD74413_REG_OUTPUT_CONFIGn_COUNT 4
	#define AD74413_REG_DAC_CODEn_RESET     0x00000000            /*      Reset Value for DAC_CODE[n]  */
	#define AD74413_REG_DAC_CODE0_RESET     0x00000000            /*      Reset Value for AD74413_REG_DAC_CODE0  */
	#define AD74413_REG_DAC_CODE1_RESET     0x00000000            /*      Reset Value for AD74413_REG_DAC_CODE1  */
	#define AD74413_REG_DAC_CODE2_RESET     0x00000000            /*      Reset Value for AD74413_REG_DAC_CODE2  */
	#define AD74413_REG_DAC_CODE3_RESET     0x00000000            /*      Reset Value for AD74413_REG_DAC_CODE3  */
	#define AD74413_REG_DAC_CODE0           0x00000016            /*  ad74413_mmr0 DAC Code Register per Channel. */
	#define AD74413_REG_DAC_CODE1           0x00000017            /*  ad74413_mmr0 DAC Code Register per Channel. */
	#define AD74413_REG_DAC_CODE2           0x00000018            /*  ad74413_mmr0 DAC Code Register per Channel. */
	#define AD74413_REG_DAC_CODE3           0x00000019            /*  ad74413_mmr0 DAC Code Register per Channel. */
	#define AD74413_REG_DAC_CODEn(i)        (AD74413_REG_DAC_CODE0 + ((i) * 1))
	#define AD74413_REG_DAC_CODEn_COUNT     4
	#define AD74413_REG_DAC_CLR_CODEn_RESET 0x00000000            /*      Reset Value for DAC_CLR_CODE[n]  */
	#define AD74413_REG_DAC_CLR_CODE0_RESET 0x00000000            /*      Reset Value for AD74413_REG_DAC_CLR_CODE0  */
	#define AD74413_REG_DAC_CLR_CODE1_RESET 0x00000000            /*      Reset Value for AD74413_REG_DAC_CLR_CODE1  */
	#define AD74413_REG_DAC_CLR_CODE2_RESET 0x00000000            /*      Reset Value for AD74413_REG_DAC_CLR_CODE2  */
	#define AD74413_REG_DAC_CLR_CODE3_RESET 0x00000000            /*      Reset Value for AD74413_REG_DAC_CLR_CODE3  */
	#define AD74413_REG_DAC_CLR_CODE0       0x0000001A            /*  ad74413_mmr0 DAC Clear Code Register per Channel */
	#define AD74413_REG_DAC_CLR_CODE1       0x0000001B            /*  ad74413_mmr0 DAC Clear Code Register per Channel */
	#define AD74413_REG_DAC_CLR_CODE2       0x0000001C            /*  ad74413_mmr0 DAC Clear Code Register per Channel */
	#define AD74413_REG_DAC_CLR_CODE3       0x0000001D            /*  ad74413_mmr0 DAC Clear Code Register per Channel */
	#define AD74413_REG_DAC_CLR_CODEn(i)    (AD74413_REG_DAC_CLR_CODE0 + ((i) * 1))
	#define AD74413_REG_DAC_CLR_CODEn_COUNT 4
	#define AD74413_REG_DAC_ACTIVEn_RESET   0x00000000            /*      Reset Value for DAC_ACTIVE[n]  */
	#define AD74413_REG_DAC_ACTIVE0_RESET   0x00000000            /*      Reset Value for AD74413_REG_DAC_ACTIVE0  */
	#define AD74413_REG_DAC_ACTIVE1_RESET   0x00000000            /*      Reset Value for AD74413_REG_DAC_ACTIVE1  */
	#define AD74413_REG_DAC_ACTIVE2_RESET   0x00000000            /*      Reset Value for AD74413_REG_DAC_ACTIVE2  */
	#define AD74413_REG_DAC_ACTIVE3_RESET   0x00000000            /*      Reset Value for AD74413_REG_DAC_ACTIVE3  */
	#define AD74413_REG_DAC_ACTIVE0         0x0000001E            /*  ad74413_mmr0 DAC Active Code Register per Channel */
	#define AD74413_REG_DAC_ACTIVE1         0x0000001F            /*  ad74413_mmr0 DAC Active Code Register per Channel */
	#define AD74413_REG_DAC_ACTIVE2         0x00000020            /*  ad74413_mmr0 DAC Active Code Register per Channel */
	#define AD74413_REG_DAC_ACTIVE3         0x00000021            /*  ad74413_mmr0 DAC Active Code Register per Channel */
	#define AD74413_REG_DAC_ACTIVEn(i)      (AD74413_REG_DAC_ACTIVE0 + ((i) * 1))
	#define AD74413_REG_DAC_ACTIVEn_COUNT   4
	#define AD74413_REG_DIN_THRESH_RESET    0x00000000            /*      Reset Value for DIN_THRESH  */
	#define AD74413_REG_DIN_THRESH          0x00000022            /*  ad74413_mmr0 Digital Input Threshold Register */
	#define AD74413_REG_ADC_CONV_CTRL_RESET 0x00000000            /*      Reset Value for ADC_CONV_CTRL  */
	#define AD74413_REG_ADC_CONV_CTRL       0x00000023            /*  ad74413_mmr0 ADC Conversion Control Register. */
	#define AD74413_REG_DIAG_ASSIGN_RESET   0x00000000            /*      Reset Value for DIAG_ASSIGN  */
	#define AD74413_REG_DIAG_ASSIGN         0x00000024            /*  ad74413_mmr0 Diagnostics Select Register */
	#define AD74413_REG_DIN_COMP_OUT_RESET  0x00000000            /*      Reset Value for DIN_COMP_OUT  */
	#define AD74413_REG_DIN_COMP_OUT        0x00000025            /*  ad74413_mmr0 Digital Output Level Register */
	#define AD74413_REG_ADC_RESULTn_RESET   0x00000000            /*      Reset Value for ADC_RESULT[n]  */
	#define AD74413_REG_ADC_RESULT0_RESET   0x00000000            /*      Reset Value for AD74413_REG_ADC_RESULT0  */
	#define AD74413_REG_ADC_RESULT1_RESET   0x00000000            /*      Reset Value for AD74413_REG_ADC_RESULT1  */
	#define AD74413_REG_ADC_RESULT2_RESET   0x00000000            /*      Reset Value for AD74413_REG_ADC_RESULT2  */
	#define AD74413_REG_ADC_RESULT3_RESET   0x00000000            /*      Reset Value for AD74413_REG_ADC_RESULT3  */
	#define AD74413_REG_ADC_RESULT0         0x00000026            /*  ad74413_mmr0 ADC Conversion Results Register per Channel */
	#define AD74413_REG_ADC_RESULT1         0x00000027            /*  ad74413_mmr0 ADC Conversion Results Register per Channel */
	#define AD74413_REG_ADC_RESULT2         0x00000028            /*  ad74413_mmr0 ADC Conversion Results Register per Channel */
	#define AD74413_REG_ADC_RESULT3         0x00000029            /*  ad74413_mmr0 ADC Conversion Results Register per Channel */
	#define AD74413_REG_ADC_RESULTn(i)      (AD74413_REG_ADC_RESULT0 + ((i) * 1))
	#define AD74413_REG_ADC_RESULTn_COUNT   4
	#define AD74413_REG_DIAG_RESULTn_RESET  0x00000000            /*      Reset Value for DIAG_RESULT[n]  */
	#define AD74413_REG_DIAG_RESULT0_RESET  0x00000000            /*      Reset Value for AD74413_REG_DIAG_RESULT0  */
	#define AD74413_REG_DIAG_RESULT1_RESET  0x00000000            /*      Reset Value for AD74413_REG_DIAG_RESULT1  */
	#define AD74413_REG_DIAG_RESULT2_RESET  0x00000000            /*      Reset Value for AD74413_REG_DIAG_RESULT2  */
	#define AD74413_REG_DIAG_RESULT3_RESET  0x00000000            /*      Reset Value for AD74413_REG_DIAG_RESULT3  */
	#define AD74413_REG_DIAG_RESULT0        0x0000002A            /*  ad74413_mmr0 Diagnostic Results Registers per Diagnostic Channel. */
	#define AD74413_REG_DIAG_RESULT1        0x0000002B            /*  ad74413_mmr0 Diagnostic Results Registers per Diagnostic Channel. */
	#define AD74413_REG_DIAG_RESULT2        0x0000002C            /*  ad74413_mmr0 Diagnostic Results Registers per Diagnostic Channel. */
	#define AD74413_REG_DIAG_RESULT3        0x0000002D            /*  ad74413_mmr0 Diagnostic Results Registers per Diagnostic Channel. */
	#define AD74413_REG_DIAG_RESULTn(i)     (AD74413_REG_DIAG_RESULT0 + ((i) * 1))
	#define AD74413_REG_DIAG_RESULTn_COUNT  4
	#define AD74413_REG_ALERT_STATUS_RESET  0x00008000            /*      Reset Value for ALERT_STATUS  */
	#define AD74413_REG_ALERT_STATUS        0x0000002E            /*  ad74413_mmr0 Alert Status Register */
	#define AD74413_REG_LIVE_STATUS_RESET   0x00000000            /*      Reset Value for LIVE_STATUS  */
	#define AD74413_REG_LIVE_STATUS         0x0000002F            /*  ad74413_mmr0 Live Status Register */
	#define AD74413_REG_ALERT_MASK_RESET    0x00000000            /*      Reset Value for ALERT_MASK  */
	#define AD74413_REG_ALERT_MASK          0x0000003C            /*  ad74413_mmr0 Alert Mask Register. */
	#define AD74413_REG_DIN_COUNTERn_RESET  0x00000000            /*      Reset Value for DIN_COUNTER[n]  */
	#define AD74413_REG_DIN_COUNTER0_RESET  0x00000000            /*      Reset Value for AD74413_REG_DIN_COUNTER0  */
	#define AD74413_REG_DIN_COUNTER1_RESET  0x00000000            /*      Reset Value for AD74413_REG_DIN_COUNTER1  */
	#define AD74413_REG_DIN_COUNTER2_RESET  0x00000000            /*      Reset Value for AD74413_REG_DIN_COUNTER2  */
	#define AD74413_REG_DIN_COUNTER3_RESET  0x00000000            /*      Reset Value for AD74413_REG_DIN_COUNTER3  */
	#define AD74413_REG_DIN_COUNTER0        0x0000003D            /*  ad74413_mmr0 Debounced Digital Input Count Register per Channel. */
	#define AD74413_REG_DIN_COUNTER1        0x0000003E            /*  ad74413_mmr0 Debounced Digital Input Count Register per Channel. */
	#define AD74413_REG_DIN_COUNTER2        0x0000003F            /*  ad74413_mmr0 Debounced Digital Input Count Register per Channel. */
	#define AD74413_REG_DIN_COUNTER3        0x00000040            /*  ad74413_mmr0 Debounced Digital Input Count Register per Channel. */
	#define AD74413_REG_DIN_COUNTERn(i)     (AD74413_REG_DIN_COUNTER0 + ((i) * 1))
	#define AD74413_REG_DIN_COUNTERn_COUNT  4
	#define AD74413_REG_READ_SELECT_RESET   0x00000000            /*      Reset Value for READ_SELECT  */
	#define AD74413_REG_READ_SELECT         0x00000041            /*  ad74413_mmr0 Readback Select Register */
	#define AD74413_REG_THERM_RST_RESET     0x00000000            /*      Reset Value for THERM_RST  */
	#define AD74413_REG_THERM_RST           0x00000043            /*  ad74413_mmr0 Thermal Reset Enable Register */
	#define AD74413_REG_CMD_KEY_RESET       0x00000000            /*      Reset Value for CMD_KEY  */
	#define AD74413_REG_CMD_KEY             0x00000044            /*  ad74413_mmr0 Command Register */
	#define AD74413_REG_SCRATCH_RESET       0x00000000            /*      Reset Value for SCRATCH  */
	#define AD74413_REG_SCRATCH             0x00000045            /*  ad74413_mmr0 Scratch or Spare Register. */
	#define AD74413_REG_SILICON_REV_RESET   0x00000008            /*      Reset Value for SILICON_REV  */
	#define AD74413_REG_SILICON_REV         0x00000046            /*  ad74413_mmr0 Silicon Revision Register */

	/* ============================================================================================================================
					ad74413_mmr Register BitMasks, Positions & Enumerations 
		 ============================================================================================================================ */
	/* -------------------------------------------------------------------------------------------------------------------------
	...
	#define ENUM_CH_FUNC_SETUP_IIN_EXT_PWR_HART 0x00000009            /*  CH_FUNC: Current Input Externally powered with HART termination impedance. */
	#define ENUM_CH_FUNC_SETUP_IIN_LOOP_PWR_HART 0x0000000A            /*  CH_FUNC: Current Input Loop powered with HART termination impedance. */
	...
	#define ENUM_ADC_CONFIG_RNG_NEG0P104_0P104V 0x00000080            /*  RANGE: -104.16mV to 104.16mV */
	...
	#define ENUM_ADC_CONFIG_SPS_10   0x00000010            /*  EN_50_60_HZ: Enables the 50/60 Hz rejection resulting in a sampling rate of 10 Samples Per Second. */
	#define ENUM_ADC_CONFIG_SPS_1K   0x00000018            /*  EN_50_60_HZ: Disables the 50/60 Hz rejection resulting in a sampling rate of 1k2 Samples Per Second. */
	...
	/* -------------------------------------------------------------------------------------------------------------------------
		 ...
		 ------------------------------------------------------------------------------------------------------------------------- */
	#define BITP_DIN_CONFIG_COUNT_EN 15            /*  Set to 1 to Enable the DIN Counter. */
	...
	#define BITP_DIN_CONFIG_DIN_RANGE 11            /*  This Bit Determines the DIN Current Sink Range */
	...
	#define BITM_DIN_CONFIG_COUNT_EN 0x00008000    /*  Set to 1 to Enable the DIN Counter. */
	...
	#define BITM_DIN_CONFIG_DIN_RANGE 0x00000800    /*  This Bit Determines the DIN Current Sink Range */
	...
	#define ENUM_DIN_RANGE_0   0x00000000            /*  DEBOUNCE_MODE: Debounce Mode 0 */
	#define ENUM_DIN_RANGE_1   0x00000080            /*  DEBOUNCE_MODE: Debounce Mode 1 */
	...
	#define ENUM_DIAG3_ASSIGN_AGND    0x00000000            /*  DIAG3_ASSIGN: Assign AGND to Diagnostic 3. */
	#define ENUM_DIAG3_ASSIGN_TEMP    0x00001000            /*  DIAG3_ASSIGN: Assign the Temperature Sensor to Diagnostic 3. */
	#define ENUM_DIAG3_ASSIGN_AVDD    0x00002000            /*  DIAG3_ASSIGN: Assign AVDD/16 to Diagnostic 3. */
	#define ENUM_DIAG3_ASSIGN_CHRG_PUMP 0x00003000            /*  DIAG3_ASSIGN: Assign the Charge Pump Voltage (AVSS) to Diagnostic 3. */
	#define ENUM_DIAG3_ASSIGN_REFOUT  0x00004000            /*  DIAG3_ASSIGN: Assign REFOUT to Diagnostic 3. */
	#define ENUM_DIAG3_ASSIGN_ALDO5V  0x00005000            /*  DIAG3_ASSIGN: Assign ALDO5V to Diagnostic 3. */
	#define ENUM_DIAG3_ASSIGN_ALDO1V8 0x00006000            /*  DIAG3_ASSIGN: Assign ALDO1V8 to Diagnostic 3. */
	#define ENUM_DIAG3_ASSIGN_DLDO1V8 0x00007000            /*  DIAG3_ASSIGN: Assign DLDO1V8 to Diagnostic 3. */
	#define ENUM_DIAG3_ASSIGN_DVCC    0x00008000            /*  DIAG3_ASSIGN: Assign DVCC to Diagnostic 3. */
	#define ENUM_DIAG3_ASSIGN_IOVDD   0x00009000            /*  DIAG3_ASSIGN: Assign IOVDD to Diagnostic 3. */
	#define ENUM_DIAG3_ASSIGN_SENSEL_A 0x0000A000            /*  DIAG3_ASSIGN: Assign SenseL_A to Diagnostic 3. */
	#define ENUM_DIAG3_ASSIGN_SENSEL_B 0x0000B000            /*  DIAG3_ASSIGN: Assign SenseL_B to Diagnostic 3. */
	#define ENUM_DIAG3_ASSIGN_SENSEL_C 0x0000C000            /*  DIAG3_ASSIGN: Assign SenseL_C to Diagnostic 3. */
	#define ENUM_DIAG3_ASSIGN_SENSEL_D 0x0000D000            /*  DIAG3_ASSIGN: Assign SenseL_D to Diagnostic 3. */
	#define ENUM_DIAG3_ASSIGN_LVIN 0x0000E000            /*  DIAG3_ASSIGN: Assign LVIN to Diagnostic 3. */
	#define ENUM_DIAG2_ASSIGN_AGND    0x00000000            /*  DIAG2_ASSIGN: Assign AGND to Diagnostic 2. */
	#define ENUM_DIAG2_ASSIGN_TEMP    0x00000100            /*  DIAG2_ASSIGN: Assign the Temperature Sensor to Diagnostic 2. */
	#define ENUM_DIAG2_ASSIGN_AVDD    0x00000200            /*  DIAG2_ASSIGN: Assign AVDD/16 to Diagnostic 2. */
	#define ENUM_DIAG2_ASSIGN_CHRG_PUMP 0x00000300            /*  DIAG2_ASSIGN: Assign the Charge Pump Voltage (AVSS) to Diagnostic 2. */
	#define ENUM_DIAG2_ASSIGN_REFOUT  0x00000400            /*  DIAG2_ASSIGN: Assign REFOUT to Diagnostic 2. */
	#define ENUM_DIAG2_ASSIGN_ALDO5V  0x00000500            /*  DIAG2_ASSIGN: Assign ALDO5V to Diagnostic 2. */
	#define ENUM_DIAG2_ASSIGN_ALDO1V8 0x00000600            /*  DIAG2_ASSIGN: Assign ALDO1V8 to Diagnostic 2. */
	#define ENUM_DIAG2_ASSIGN_DLDO1V8 0x00000700            /*  DIAG2_ASSIGN: Assign DLDO1V8 to Diagnostic 2. */
	#define ENUM_DIAG2_ASSIGN_DVCC    0x00000800            /*  DIAG2_ASSIGN: Assign DVCC to Diagnostic 2. */
	#define ENUM_DIAG2_ASSIGN_IOVDD   0x00000900            /*  DIAG2_ASSIGN: Assign IOVDD to Diagnostic 2. */
	#define ENUM_DIAG2_ASSIGN_SENSEL_A 0x00000A00            /*  DIAG2_ASSIGN: Assign SenseL_A to Diagnostic 2. */
	#define ENUM_DIAG2_ASSIGN_SENSEL_B 0x00000B00            /*  DIAG2_ASSIGN: Assign SenseL_B to Diagnostic 2. */
	#define ENUM_DIAG2_ASSIGN_SENSEL_C 0x00000C00            /*  DIAG2_ASSIGN: Assign SenseL_C to Diagnostic 2. */
	#define ENUM_DIAG2_ASSIGN_SENSEL_D 0x00000D00            /*  DIAG2_ASSIGN: Assign SenseL_D to Diagnostic 2. */
	#define ENUM_DIAG2_ASSIGN_LVIN 0x00000E00            /*  DIAG3_ASSIGN: Assign LVIN to Diagnostic 2. */
	#define ENUM_DIAG1_ASSIGN_AGND    0x00000000            /*  DIAG1_ASSIGN: Assign AGND to Diagnostic 1. */
	#define ENUM_DIAG1_ASSIGN_TEMP    0x00000010            /*  DIAG1_ASSIGN: Assign the Temperature Sensor to Diagnostic 1. */
	#define ENUM_DIAG1_ASSIGN_AVDD    0x00000020            /*  DIAG1_ASSIGN: Assign AVDD/16 to Diagnostic 1. */
	#define ENUM_DIAG1_ASSIGN_CHRG_PUMP 0x00000030            /*  DIAG1_ASSIGN: Assign the Charge Pump Voltage (AVSS) to Diagnostic 1. */
	#define ENUM_DIAG1_ASSIGN_REFOUT  0x00000040            /*  DIAG1_ASSIGN: Assign REFOUT to Diagnostic 1. */
	#define ENUM_DIAG1_ASSIGN_ALDO5V  0x00000050            /*  DIAG1_ASSIGN: Assign ALDO5V to Diagnostic 1. */
	#define ENUM_DIAG1_ASSIGN_ALDO1V8 0x00000060            /*  DIAG1_ASSIGN: Assign ALDO1V8 to Diagnostic 1. */
	#define ENUM_DIAG1_ASSIGN_DLDO1V8 0x00000070            /*  DIAG1_ASSIGN: Assign DLDO1V8 to Diagnostic 1. */
	#define ENUM_DIAG1_ASSIGN_DVCC    0x00000080            /*  DIAG1_ASSIGN: Assign DVCC to Diagnostic 1. */
	#define ENUM_DIAG1_ASSIGN_IOVDD   0x00000090            /*  DIAG1_ASSIGN: Assign IOVDD to Diagnostic 1. */
	#define ENUM_DIAG1_ASSIGN_SENSEL_A 0x000000A0            /*  DIAG1_ASSIGN: Assign SenseL_A to Diagnostic 1. */
	#define ENUM_DIAG1_ASSIGN_SENSEL_B 0x000000B0            /*  DIAG1_ASSIGN: Assign SenseL_B to Diagnostic 1. */
	#define ENUM_DIAG1_ASSIGN_SENSEL_C 0x000000C0            /*  DIAG1_ASSIGN: Assign SenseL_C to Diagnostic 1. */
	#define ENUM_DIAG1_ASSIGN_SENSEL_D 0x000000D0            /*  DIAG1_ASSIGN: Assign SenseL_D to Diagnostic 1. */
	#define ENUM_DIAG1_ASSIGN_LVIN 0x000000E0            /*  DIAG3_ASSIGN: Assign LVIN to Diagnostic 1. */
	#define ENUM_DIAG0_ASSIGN_AGND    0x00000000            /*  DIAG0_ASSIGN: Assign AGND to Diagnostic 0 */
	#define ENUM_DIAG0_ASSIGN_TEMP    0x00000001            /*  DIAG0_ASSIGN: Assign the Temperature Sensor to Diagnostic 0. */
	#define ENUM_DIAG0_ASSIGN_AVDD    0x00000002            /*  DIAG0_ASSIGN: Assign AVDD/16 to Diagnostic 0 */
	#define ENUM_DIAG0_ASSIGN_CHRG_PUMP 0x00000003            /*  DIAG0_ASSIGN: Assign the Charge Pump Voltage (AVSS) to Diagnostic 0. */
	#define ENUM_DIAG0_ASSIGN_REFOUT  0x00000004            /*  DIAG0_ASSIGN: Assign REFOUT*0.8 to Diagnostic 0. */
	#define ENUM_DIAG0_ASSIGN_ALDO5V  0x00000005            /*  DIAG0_ASSIGN: Assign ALDO5V/7 to Diagnostic 0. */
	#define ENUM_DIAG0_ASSIGN_ALDO1V8 0x00000006            /*  DIAG0_ASSIGN: Assign ALDO1V8/2.33 to Diagnostic 0. */
	#define ENUM_DIAG0_ASSIGN_DLDO1V8 0x00000007            /*  DIAG0_ASSIGN: Assign DLDO1V8/3 to Diagnostic 0. */
	#define ENUM_DIAG0_ASSIGN_DVCC    0x00000008            /*  DIAG0_ASSIGN: Assign DVCC/3.3 to Diagnostic 0. */
	#define ENUM_DIAG0_ASSIGN_IOVDD   0x00000009            /*  DIAG0_ASSIGN: Assign IOVDD/3.3 to Diagnostic 0. */
	#define ENUM_DIAG0_ASSIGN_SENSEL_A 0x0000000A            /*  DIAG0_ASSIGN: Assign SenseL_A/12 to Diagnostic 0. */
	#define ENUM_DIAG0_ASSIGN_SENSEL_B 0x0000000B            /*  DIAG0_ASSIGN: Assign SenseL_B/12 to Diagnostic 0. */
	#define ENUM_DIAG0_ASSIGN_SENSEL_C 0x0000000C            /*  DIAG0_ASSIGN: Assign SenseL_C/12 to Diagnostic 0. */
	#define ENUM_DIAG0_ASSIGN_SENSEL_D 0x0000000D            /*  DIAG0_ASSIGN: Assign SenseL_D/12 to Diagnostic 0. */
	#define ENUM_DIAG0_ASSIGN_LVIN 0x0000000E            /*  DIAG3_ASSIGN: Assign LVIN to Diagnostic 0. */
	/* -------------------------------------------------------------------------------------------------------------------------
	...
	/* -------------------------------------------------------------------------------------------------------------------------
						DIN_COUNTER[n]            Pos/Masks         Description
		 ------------------------------------------------------------------------------------------------------------------------- */
	#define BITP_DIN_COUNTER_DIN_CNT  0            /*  Contains the 16bit DIN Count Value on Channeln  */
	#define BITM_DIN_COUNTER_DIN_CNT 0x0000FFFF    /*  Contains the 16bit DIN Count Value on Channeln  */
	...
	#define ENUM_READ_SELECT_DIN_COUNTERA 0x0000003D        /*READBACK_ADDR: DIN_COUNTERA */
	#define ENUM_READ_SELECT_DIN_COUNTERB 0x0000003E        /*READBACK_ADDR: DIN_COUNTERB */
	#define ENUM_READ_SELECT_DIN_COUNTERC 0x0000003F        /*READBACK_ADDR: DIN_COUNTERC */
	#define ENUM_READ_SELECT_DIN_COUNTERD 0x00000040        /*READBACK_ADDR: DIN_COUNTERD */
	...
	/* ==================== || ============================ || ==================== */
	/* ==================== || DEFINITION OF DATA AND FUNCS || ==================== */
	/* ==================== \/ ============================ \/ ==================== */

	
	#define MAX_SUPPORTED_AD74413R						4
	
	#define AD74413R_SPI											MDR_SSP1
	
	#define AD74413R_NUMBER_OF_ADC_CHANNELS		4
	#define AD74413R_NUMBER_OF_DIAGNOSTICS		4
	#define AD74413R_NUMBER_OF_CHANNELS				4
	#define AD74413R_MAX_NUM_REGS_TO_READ			0
	
	#define CHIP_IN_USE				0x01
	#define CHIP_UNUSED				0x00
	#define CHIP_IN_WORK			0x02
	#define CHIP_IN_SLEEP			0xFD
		
	#define VOLTAGE_OUTPUT_MIN				0.0f
	#define VOLTAGE_OUTPUT_MAX				11.0f
	#define VOLTAGE_DAC_CODE_FOR_1V		744.64f
	
	#define CURRENT_OUTPUT_MIN				0.0f
	#define CURRENT_OUTPUT_MAX				25.0f
	#define CURRENT_DAC_CODE_FOR_1MA	327.64f
	
	#define ADC_DIGIT							65535.0f
	#define R_SENSE								100.0f
	#define R_PULL_UP							2100.0f
		
	#define V_MIN_0V							0.0f
	#define V_MIN_M2P5V						-2.5f
	
	#define V_MAX_0								0.0f
	#define V_MAX_2P5V						2.5f
	#define V_MAX_10V							10.0f
	
	#define V_RNG_0_10V						10.0f
	#define V_RNG_0_2P5V					2.5f
	#define V_RNG_M2P5V_0V				2.5f
	#define V_RNG_M2P5V_2P5V			5.0f
	
	
	typedef enum
	{
		AD74413R_RESULT_OK,
		AD74413R_RESULT_SPI_FAILURE,                     /*! Unknown failure. */
		AD74413R_RESULT_CRC_FAILURE,                     /*! Unknown failure. */
		AD74413R_RESULT_REG_WRONG_DATA_IS_WRITTEN,
		
		ad74413_RESULT_NO_RESOURCES,                    /*! Not enough resources available */
		ad74413_RESULT_BSP_FAILURE,                     /*! A failure associated with initialising the MCU . */
		ad74413_RESULT_FAILURE,                         /*! Unknown failure. */
		ad74413_RESULT_UNKNOWN_CHIP,                    // this Chip is not known.
		ad74413_RESULT_INACTIVE_CHIP,                   // this Chip is not initialised.
		ad74413_RESULT_CHANNEL_ERROR,                   // this channel doesn't exist
		ad74413_RESULT_PIN_ERROR,                       // this Pin type doesn't exist
		ad74413_RESULT_CHANNEL_TYPE_ERROR,              // this channel type doesn't exist/notSupported.
		ad74413_RESULT_WRONG_CHANNEL_ACTION_FOR_TYPE,   // this channel isn't configured to do this, setOutput for an Input???
		
		ad74413_RESULT_INVALID_REQUEST,                 /*! Invalid request */
	...
	typedef enum
	{
		AD74413R_CHANNEL_OFF = 0,
		AD74413R_HIGH_IMPEDANCE,
		AD74413R_VOLTAGE_OUTPUT,
		AD74413R_CURRENT_OUTPUT,
		AD74413R_VOLTAGE_MEASUREMENT,
		AD74413R_CURRENT_MEASUREMENT,
		AD74413R_RESISTANCE_MEASUREMENT
	}AD74413R_CHANNEL_MODE;
	...
	typedef struct
	{
		bool			reload;
		float			actualVal;
		uint16_t	averageCounts;
		uint16_t	averageCounter;
		float			minVal;
		float			nDeviationPercentage;
		float			averageVal;
		float			maxVal;
		float			pDeviationPercentage;
	}tAccuracy;
	...
	typedef struct
	{
		...
		uint16_t	VI_ERR_C					:		1;
		uint16_t	VI_ERR_D					:		1;
		uint16_t	HI_TEMP_ERR				:		1;
		uint16_t	CHARGE_PUMP_ERR		:		1;
		uint16_t	ALDO5V_ERR				:		1;
		uint16_t	AVDD_ERR					:		1;
		uint16_t	DVCC_ERR					:		1;
		uint16_t	ALDO1V8_ERR				:		1;
		uint16_t	ADC_CONV_ERR			:		1;
		uint16_t	ADC_SAT_ERR				:		1;
		uint16_t	SPI_SCLK_CNT_ERR	:		1;
		uint16_t	SPI_CRC_ERR				:		1;
		uint16_t	CAL_MEM_ERR				:		1;
		uint16_t	RESET_OCCURRED		:		1;
	}tAlertInfo;
	...
	typedef struct
	{
		...
		tPinsInfo					pinsInfo;
		uint8_t						chUsage;
		tChannelInfo			chInfo[AD74413R_NUMBER_OF_CHANNELS];
		tDiagnosticInfo		diagInfo[AD74413R_NUMBER_OF_DIAGNOSTICS];
		tAlertInfo				alertInfo;
		tRegister					readReg[AD74413R_MAX_NUM_REGS_TO_READ];
		uint8_t						chipStatus;
	}AD74413R_API;
	
	
	extern AD74413R_API APIDefinitions[MAX_SUPPORTED_AD74413R];
